...
pygame.display.set_caption("Fake Aim Labs")

TARGET_INCREMENT = 600 # in ms
...
def end_screen(win, elapsed_time, targets_pressed, clicks):
    ...
    exit_label = LABEL_FONT.render("Press any key to exit...", 1, "orange")
    game_over =  LABEL_FONT.render("GAME OVER!", 1, "orange")

    win.blit(game_over, (get_middle(game_over), 100))
    ...
    win.blit(exit_label, (get_middle(exit_label), 450))
